    ...
    <section className="flex-1 p-8 bg-dark-10 min-h-[calc(100%-70px)] h-full overflow-y-auto py-20 relative z-0">
      ...
      <div className="grid gap-6">
        <div className="col-span-full">
          <div className="grid grid-cols-7 justify-between gap-6 mb-6">
            <FinancCard title="T-12 NOI" icon={T12NOI} number="$1,867,449" />
            <FinancCard title="T-3/T-12 NOI" icon={T3noi} number="$1,660,985" />
            <FinancCard
              ...
              statusLeft="NRI"
              statusRight="$1,319"
              statusLeftA="Other Income"
              statusRightA="$182"
              statusLeftB="EGI"
              statusRightB="$1,501"
            />
            <FinancCard
              title="Expenses Per Unit"
              icon={Expenses}
              number=""
              statusLeft="Taus"
              statusRight="$546"
              statusLeftA="Other Exp"
              statusRightA="$182"
              statusLeftB="Total "
              statusRightB="$1,501"
            />
            ...
            <FinancCartCard
              ...
              stopColor="#FF5050"
              strokeColor="#FF5050"
              linearGradientColor="linearGradientColor4"
              data={sampleData}
            />
            <FinancCartCard
              title="Expense Trend Line"
              stopColor="#68C8F8"
              strokeColor="#68C8F8"
              linearGradientColor="linearGradientColor5"
              data={sampleData1}
            />
          </div>
        </div>

...
import UnitRenovationSummaryTable from "../../components/UnitRenovationSummaryTable/UnitRenovationSummaryTable";

export default function UnitRenovationSummary() {
    return (
      ...
      <input
        type="date"
        className="bg-transparent transition-all hover:bg-dark-5 text-dark-2 font-medium text-sm rounded-lg border-dark-4 border-1 outline-none focus:border-dark-5 w-full h-[52px] p-4" placeholder="17-Mar-25"
      />
    </div>
                    <Link
                        to=""

...
export default function MaintenanceInventory() {
  const [tableData, setTableData] = useState([
    { itemName: "Item Name", Quantity: "20", UsedBy:"Maintenance Staff" },
    { itemName: "Item Name", Quantity: "30", UsedBy:"Maintenance Staff" },
    { itemName: "Item Name", Quantity: "30", UsedBy:"Maintenance Staff" },
    { itemName: "Item Name", Quantity: "20", UsedBy:"Maintenance Staff" },
    { itemName: "Item Name", Quantity: "30", UsedBy:"Maintenance Staff" },
    { itemName: "Item Name", Quantity: "30", UsedBy:"Maintenance Staff" },

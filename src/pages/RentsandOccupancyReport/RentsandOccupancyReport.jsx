  ...
  return (
    <section className="flex-1 p-8 bg-dark-10 min-h-[calc(100%-70px)] h-full overflow-y-auto py-20 relative z-0">
      ...
      <div className="grid gap-6">
        <div className="grid grid-cols-2 gap-6">
          <div className="growthcarf">
            <div className="bg-white p-6 rounded-lg relative h-full ">
              ...
              />
              <div className="flex gap-3 font-normal text-[14px] text-[#54616B] justify-center divide-x-1 divide-solid divide-[#BBC5CD]">
                <div className="textcard flex-1 p-3">
                  <h3 className="text-[18px] font-bold text-dark-1 leading-[1.4] mb-6  flex gap-3 justify-self-center">
                    Avg Rent
                  </h3>
                  <div className="grid grid-cols-3 gap-6 font-semibold text-[16px] text-[#001924] justify-items-center">
                    <span>T1</span>
                    <span>T1</span>
                    <span>T1</span>
                  </div>
                  <div className="grid grid-cols-3 gap-6 font-bold text-[16px] text-[#54616B] justify-items-center">
                    <span>$1,319</span>
                    <span>$1,319</span>
                    <span>$1,319</span>
                  </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <PropertyConversionChart title="Classic Units" />
          <BenchMarkingExpensePerUnit
            title="New Lease Trade Outs "
            data={expenseData}
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <PropertyConversionChart
            title="Renewal Trade Outs"
            barcolor="#FFC362"
          />
        </div>
        <div className="grid grid-cols-2 gap-6">
          <div className="growthcarf">
            <div className="bg-white p-6 rounded-lg relative h-100">
              <img
                src={dragIcon}
                alt="Drag Icon"
                className="absolute right-3 top-3"

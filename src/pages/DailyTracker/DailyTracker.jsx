    ...
    <section className="flex-1 p-8 bg-dark-10 min-h-[calc(100%-70px)] h-full overflow-y-auto py-20 relative z-0">
      ...
      <div className="flex gap-6 justify-between items-center mb-[34px] pt-8">
        <h2 className="text-[28px] font-bold text-dark-1 leading-[1.35]">
          Daily Operation Tracker
        </h2>
        <div className="flex gap-2.5">
          {/* Edit Button */}
          <input
            type="date"
            className="bg-transparent transition-all hover:bg-dark-5 text-dark-2 font-medium text-sm rounded-lg border-dark-4 border-1 outline-none focus:border-dark-5 w-full h-[52px] p-4"
            placeholder="17-Mar-25"
          />
          <Link
            to=""
          ...
          <Link
            to=""
            className="text-base px-[17px] py-2 border border-dark-4 bg-transparent rounded-lg text-dark-2 font-black transition-colors duration-200 hover:bg-dark-2 hover:text-white cursor-pointer inline-flex items-center gap-2 group col-auto"
          >
            <svg
              width="18"
              height="18"
      ...
      <div className="flex flex-col gap-6">
          ...
          <div className=" mt-8">
            <div className="progressBarWrap ">
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Gross Potential Rent</div>
               <CustomProgressBar raised= {350000} goal={471068} bgColor={"#30D287"} baseBgColor={"#E6FAF1"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$471,068</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Net Rental Revenue</div>
               <CustomProgressBar raised= {400000} goal={410580} bgColor={"#30D287"} baseBgColor={"#E6FAF1"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$410,580</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Utility Income</div>
               <CustomProgressBar raised= {39000} goal={43846} bgColor={"#45C7FF"} baseBgColor={"#E9F8FF"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$43,846</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Other Income</div>
               <CustomProgressBar raised= {12279} goal={18999} bgColor={"#FFC362"} baseBgColor={"#FFF8EC"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$18,999</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Total  Income</div>
        ...
        <div className="p-6 bg-white rounded-lg">
          ...
          <div className=" mt-8">
            <div className="progressBarWrap ">
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Payroll</div>
               <CustomProgressBar raised= {350000} goal={471068} bgColor={"#E9EDF0"} baseBgColor={"#D8DFE5"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$471,068</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">General & Admin</div>
               <CustomProgressBar raised= {400000} goal={410580} bgColor={"#E9EDF0"} baseBgColor={"#D8DFE5"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$410,580</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Marketing</div>
               <CustomProgressBar raised= {39000} goal={43846} bgColor={"#E9EDF0"} baseBgColor={"#D8DFE5"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$43,846</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Repairs & Maintenance</div>
               <CustomProgressBar raised= {12279} goal={18999} bgColor={"#E9EDF0"} baseBgColor={"#D8DFE5"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$18,999</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">
                  <div className="progressBarItemInnerText shrink-0">Utilities</div>
               <CustomProgressBar raised= {16000} goal={18999} bgColor={"#E9EDF0"} baseBgColor={"#D8DFE5"} />
                  <div className="progressBarItemInnerText  shrink-0 text-right">$18,999</div>
              </div>
              <div className="progressBarItem flex gap-4 mb-8">

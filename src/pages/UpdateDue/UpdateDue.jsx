...
import IncompleteFinancial from "../../components/IncompleteFinancial/IncompleteFinancial";
import UpdateDueDataTable from "../../components/UpdateDueDataTable/UpdateDueDataTable";

const Tabs = () => {
    const [activeTab, setActiveTab] = useState(0);

    const tabs = [
        { title: "Vacant (19)", content: <UpdateDueDataTable /> },
        {
            title: "Incomplete Financials (8)",
            content: <IncompleteFinancial />,
        },
    ];
...
export default function UpdateDue() {
    return (

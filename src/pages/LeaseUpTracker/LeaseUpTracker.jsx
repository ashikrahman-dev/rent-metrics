...
import LeaseUpTrackerTable from "../../components/Charts/LeaseUpTrackerTable/LeaseUpTrackerTable";
import DelinquencyChart from "../../components/Charts/DelinquencyChart/DelinquencyChart";
import LeaseUpTrackerChart from "../../components/Charts/LeaseUpTrackerChart/LeaseUpTtackerChart";
...
export default function LeaseUpTracker() {
    return (
        <section className="flex-1 p-8 bg-dark-10 min-h-[calc(100%-70px)] h-full overflow-y-auto py-20 relative z-0">
            ...
            <div className="mb-3 ">
            <LeaseUpTrackerTable></LeaseUpTrackerTable>
                  <div className=" mt-8">
                  <LeaseUpTrackerChart
                      title="Delinquency"
                      data={expenseData}

...
import RecentRentRollDataTable from "../../components/RecentRentRollDataTable/RecentRentRollDataTable";

export default function AverageEffectiveRent() {
    return (
        <section className="flex-1 p-8 bg-dark-10 min-h-[calc(100%-70px)] h-full overflow-y-auto py-20 relative z-0">
            ...
            <div className="flex flex-col gap-6">
                <div className="p-6 bg-white rounded-lg">
                    ...
                    <div className=" mt-8">
                        <RecentRentRollDataTable />
                    </div>
                </div>

                <ApplicationConversionMonthChart title="Average Effective Rent" />
            </div>
        </section>
    );
}

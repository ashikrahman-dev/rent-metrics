...
import APIIntegrationTab from "../../components/APIIntegrationTab/APIIntegrationTab";
import ExcelImportTab from "../../components/ExcelImportTab/ExcelImportTab";
...
const Tabs = () => {
    ...
    const tabs = [
        { title: "API Integration", content: <APIIntegrationTab /> },
        { title: "Excel Import", content: <ExcelImportTab /> },
        { title: "Manual Input", content: <ManualInputTab /> }, 
    ];
...
export default function ManualInputofData() {
    return (

...
export default function DataTable() {
    ...
    const rateData = [
        {
            label: "T3A 4.75%",
            values: [
                "$72,069,567", "$68,125,980", "$74,325,450", "$69,872,300", 
                "$82,510,670", "$91,425,750", "$54,782,900", "$78,934,520", 
                "$65,387,200", "$71,245,780", "$48,762,340", "$79,214,600"
            ]
        },
        {
            label: "T3A 4.50%",
            values: [
                "$68,272,675", "$66,921,450", "$71,243,980", "$67,458,320", 
                "$79,634,520", "$88,120,760", "$52,345,870", "$75,621,340", 
                "$63,245,790", "$67,824,530", "$46,238,970", "$77,452,180"
            ]
        },
        {
            label: "T3A 4.25%",
            values: [
                "$70,898,906", "$67,852,340", "$72,541,230", "$68,741,590", 
                "$80,256,470", "$89,547,820", "$53,264,780", "$76,958,230", 
                "$64,127,850", "$69,354,720", "$47,325,840", "$78,214,390"
            ]
        },
        {
            label: "T3A 4.00%",
            values: [
                "$65,750,567", "$64,123,780", "$68,954,210", "$65,234,570", 
                "$76,521,340", "$85,712,450", "$50,123,780", "$73,451,260", 
                "$61,234,590", "$64,952,380", "$44,325,670", "$74,325,980"
            ]
        },
        {
            label: "T3A 3.75%",
    ...
    return (
        <div className="w-full overflow-x-auto border border-dark-5 rounded-2xl font-red-hat-display">
            <table className="min-w-full border-collapse">
                <thead>
                    <tr className="bg-white text-sm font-bold text-dark-2">
                        <th
                            className="py-6 px-5 text-left border-b border-r border-dark-5 border-b-dark-3 cursor-pointer rounded-l-2xl "

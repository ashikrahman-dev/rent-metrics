...
export default function OccupancySmallDataTable({title, initialAssets, occupancyTableData}) {
                    ...
                    <table className="min-w-full border-collapse bg-white">
                        <thead>
                            <tr className="bg-dark-9 text-sm font-bold text-dark-2 uppercase">
                                ...
                                {occupancyTableData.map((rate, idx) => (
                                    <th
                                        key={idx}
                        ...
                        <tbody>
                            {assets.map((asset, rowIdx) => (
                                ...
                                >
                                    ...
                                    {occupancyTableData.map((rate, rateIdx) => (
                                        <td
                                            key={rateIdx}

...
export default function PropertyConversionChart({ title, barcolor = "#2970CC" }) {
  return (
    <div className="bg-white p-6 rounded-lg col-span-1 relative">
      <img src={dragIcon} alt="Drag Icon" className="absolute right-3 top-3" />
      <h2 className="text-lg font-bold text-dark-1 leading-[1.4] mb-10 flex gap-3 items-center">
        {title || "Application Cohort Conversion by Property"}

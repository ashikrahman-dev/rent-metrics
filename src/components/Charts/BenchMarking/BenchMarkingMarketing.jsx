...
const data = [
    { name: "Jan-24", value: 7.0 },
    { name: "Feb-24", value: 13.0 },
    { name: "Mar-24", value: 1.0 },
    { name: "Apr-24", value: 8.0 },
    { name: "May-24", value: 5.5 },
    { name: "Jun-24", value: 9.0 },
    { name: "Jul-24", value: 2.0 },
    { name: "Aug-24", value: 25.0 },
    { name: "Sep-24", value: 13.0 },
    { name: "Oct-24", value: 13.5 },
    { name: "Nov-24", value: 17.30 },
    { name: "Dec-24", value: 15.0 },
];

export default function BenchMarkingMarketing() {
    return (

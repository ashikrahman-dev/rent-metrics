...
export default function OccupancyChartMain({
  title,
  data = [],
  ...
  return (
    <div className="bg-white rounded-lg col-span-1 relative">
      <img
        src={dragIcon}
        alt="Drag Icon"
      ...
      />
      {/* Title */}
      <h2 className="text-lg font-bold text-dark-1 leading-[1.4] mb-4 flex gap-4 items-center">
      ...
      {/* Chart */}
      <div className="w-full h-[112px] bg-white">
